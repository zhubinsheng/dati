			...
			Ext.onReady(function(){
			    ...
			    papersStore = Ext.create('Ext.data.Store', {
			        ...
			        proxy: {
			            ...
			            url: '<%=path%>/papersAction!getStuPapersAnsweredList',
			            reader: {
			            	type: 'json',
			                root: 'root',
			    ...
			    var tbar = Ext.create("Ext.toolbar.Toolbar", {
			    	items: [
			    		{text: '考试结果', 	iconCls: 'Applicationosxstart', 		id: 'result', 		handler: tbarFn}, 
			    			'-',
			    ...
			    function tbarFn(btn,pressed){
			    	if (btn.id == 'result'){
			    		...
			    		var url = "<%=path%>/papersAction!getExamResultPage?user_id=${userInfo.id}&papers_id=" + row.get("papers_id");
